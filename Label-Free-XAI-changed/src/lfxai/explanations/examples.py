...
class SimplEx(ExampleBasedExplainer, ABC):
    ...
    def compute_weights(
        ...
        '''
        The parameter n_epoch was challenging to fine-tune, prompting the implementation of a stopping criterion.
        This criterion enables the selection of a high number of epochs while ensuring that the algorithm terminates
        if only minor improvements are observed, preventing it from running excessively long.
        '''
